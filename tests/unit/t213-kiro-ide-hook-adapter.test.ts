// t213-kiro-ide-hook-adapter: the Kiro IDE hook shim reads context from the
...
const PINNED_CLONE_ID = "testcloneid213";
...
function scratchProject(withState: boolean): string {
  const dir = mkdtempSync(join(tmpdir(), "t213-"));
...
describe("t213 Kiro IDE hook adapter (USER_PROMPT env context)", () => {
...
describe("t213 forward-only sync-statusline (finding 1: no state resurrection)", () => {
...
describe("t213 latestStartedStageSlug filters single-stage rows (finding 2)", () => {
...
describe("t213 extractWrittenPath robustness (finding 4)", () => {
...
describe("t213 log-subagent identity extraction (#459)", () => {
...
describe("t213 failed tool calls are not audited as writes (#417)", () => {
